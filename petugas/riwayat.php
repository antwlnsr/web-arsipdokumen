        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $saya = $_SESSION['id'];
                    $arsip = mysqli_query($koneksi,"SELECT * FROM riwayat,arsip,staf WHERE riwayat_arsip=arsip_id and riwayat_staf=staf_id and arsip_petugas='$saya' ORDER BY riwayat_id DESC");
