...
<head>
    ...
    <title>Petugas - Arsip BAWASLU</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="#"><img class="main-logo" src="../assets/img/logo/arsip1.png" alt="" /></a>
                <strong><a href="#"><img src="../assets/img/logo/arsip2.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="staf.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Staf</span></a>
                        </li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/arsip1.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Informasi Arsip</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $id_saya = $_SESSION['id'];
                                                            $arsip = mysqli_query($koneksi,"SELECT * FROM riwayat,arsip,staf WHERE riwayat_arsip=arsip_id and riwayat_staf=staf_id and arsip_petugas='$id_saya' ORDER BY riwayat_id DESC");
                                                                    ...
                                                                    <a href="riwayat.php">
                                                                        <div class="notification-content">
                                                                           <p>
                                                                            ...
                                                                            <br>
                                                                            <b><?php echo $p['staf_nama'] ?></b> menunduh <b><?php echo $p['arsip_nama'] ?></b>.
                                                                        </p>
                                                                    </div>
                                                                </a>
                                                                <hr>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    if($profil['petugas_foto'] == ""){ 
                                                      ?>
                                                      <img src="../gambar/sistem/user2.png" style="width: 25px;height: 25px">
                                                  <?php }else{ ?>
                                                    <img src="../gambar/petugas/<?php echo $profil['petugas_foto'] ?>" style="width: 25px;height: 25px">
                                                <?php } ?>
