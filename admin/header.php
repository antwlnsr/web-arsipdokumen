...
<head>
    ...
    <title>Admin - Arsip BAWASLU</title>
                                        ...
                                        <div class="header-right-info">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $arsip = mysqli_query($koneksi,"SELECT * FROM riwayat,arsip,staf WHERE riwayat_arsip=arsip_id and riwayat_staf=staf_id ORDER BY riwayat_id DESC");
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                  ...
                                                  <?php }else{ ?>
                                                    <img src="../gambar/admin/<?php echo $profil['admin_foto'] ?>" style="width: 25px;height: 25px">
                                                <?php } ?>
