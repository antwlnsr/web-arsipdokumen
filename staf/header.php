...
<head>
    ...
    <title>Staf - Arsip BAWASLU</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.php"><img class="main-logo" src="../assets/img/logo/arsip1.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    <?php 
                                                    $id_user = $_SESSION['id'];
                                                    $profil = mysqli_query($koneksi,"select * from staf where staf_id='$id_user'");
                                                    $profil = mysqli_fetch_assoc($profil);
                                                    if($profil['staf_foto'] == ""){ 
                                                        ?>
                                                        <img src="../gambar/sistem/user2.png">
                                                        <?php 
                                                    }else{ 
                                                        ?>
                                                        <img src="../gambar/user/<?php echo $profil['staf_foto'] ?>">
                                                        <?php 
                                                    } 
                                                    ?>
                                                    <span class="admin-name"><?php echo $_SESSION['nama']; ?> [ <b>Staf</b> ]</span>
