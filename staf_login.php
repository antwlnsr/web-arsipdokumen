...
<head>
    ...
    <title>Login Staf | Arsip BAWASLU</title>
...
<body>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_staf_login.php" method="POST" id="loginForm">
	...
	<body class="hold-transition login-page" style="background:#f2f4f5">
</body>
</html>